...
internal fun AlertDialogImpl(
  ...
  DialogImpl(
    ...
    AlertDialogContent(
      ...
      title = title,
      text = text,
      shape = DialogTokens.ContainerShape.toShape(),
      containerColor = DialogTokens.ContainerColor.toColor(),
      ...
      iconContentColor = DialogTokens.IconColor.toColor(),
      titleContentColor = DialogTokens.SubheadColor.toColor(),
      textContentColor = DialogTokens.SupportingTextColor.toColor(),
    )
  }
}
